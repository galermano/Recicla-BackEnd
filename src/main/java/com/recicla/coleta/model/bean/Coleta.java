...
public class Coleta {
	...
	public Coleta(int id, int idStatus, String compl, int quantidade, Date dataSol, Date dataCon, int idLogradouroR,
			int idLogradouroE, int idUsuarioR, int idUsuarioE, int idMaterial) {
		super();
		this.id = id;
		this.idStatus = idStatus;
		this.compl = compl;
	...
	public Coleta(int id, int idStatus, String compl, int quantidade, Date dataSol, Date dataCon, int idLogradouroR,
			Logradouro logradouroR, int idLogradouroE, Logradouro logradouroE, int idUsuarioR, Usuario usuarioR,
			int idUsuarioE, Usuario usuarioE, int idMaterial, Material material) {
		super();
		this.id = id;
		this.idStatus = idStatus;
		this.compl = compl;
